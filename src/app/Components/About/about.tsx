...
import { motion } from "framer-motion";
import dynamic from "next/dynamic";
import { FaHtml5, FaCss3Alt, FaJs, FaReact, FaNode, FaFigma, FaDatabase, FaBootstrap, FaNodeJs, FaBrain } from "react-icons/fa";
import { SiTypescript, SiNextdotjs, SiTailwindcss, SiStripe, SiCanva, SiSanity, SiGraphql, SiDocker, SiClerk, SiPython, SiShadcnui, SiN8N, SiOpenai } from "react-icons/si";
import SocialMediaCard from "../navigator";
  ...
  const agenticSkills = [
    {
      ...
      description: "Building intelligent agents and automation workflows",
      items: [
        { name: "n8n", icon: <SiN8N className="text-green-400" /> },
        { name: "OpenAI Agent SDK", icon: <SiOpenai className="text-purple-400" /> },
...
>
  ...
  <motion.p
    ...
    transition={{ delay: 0.5 }}
  >
  Crafting end-to-end digital experiences and advancing the next era of
  intelligent, autonomous AI agents. Focused on modern web architectures,
  agentic AI systems, and solutions built for performance, scalability, and
  real-world impact.
  </motion.p>
</motion.div>
        ...
        {/* Agentic Development Card - New Row */}
        <motion.div 
          ...
          viewport={{ once: true, margin: "-100px" }}
        >
          {/* Empty spacer columns for md and larger screens */}
          <div className="hidden md:block"></div>
          
          {/* Agentic Development Card centered in the middle */}
          {agenticSkills.map((category, index) => (
            <motion.div
              key={index}
              variants={cardVariants}
              className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-lg border border-white/10 hover:border-teal-400/20 transition-all duration-300 shadow-2xl shadow-black/30"
          ...
          {/* Empty spacer column for md and larger screens */}
          <div className="hidden md:block"></div>
        </motion.div>
